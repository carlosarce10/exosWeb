<template>
  <q-layout >
    ...
    >
    <q-scroll-area style="height: calc(100% - 150px); margin-top: 50px; border-right: 1px solid #ddd; color:black " >
          <q-list padding class="menu-list">
            <q-item clickable v-ripple v-scroll-to="'#nosotros'" @click="leftDrawerOpen = !leftDrawerOpen">
              <q-item-section>
                Nostros
              </q-item-section>
            </q-item>
            <q-item clickable v-ripple v-scroll-to="'#experiencia'" @click="leftDrawerOpen = !leftDrawerOpen">
              <q-item-section>
                Experiencia
              </q-item-section>
            </q-item>
            <q-item clickable v-ripple v-scroll-to="'#productos'" @click="leftDrawerOpen = !leftDrawerOpen">
              <q-item-section>
                Producto
              </q-item-section>
            </q-item>
            <q-item clickable v-ripple v-scroll-to="'#servicios'" @click="leftDrawerOpen = !leftDrawerOpen">
              <q-item-section >
                Servicios
              </q-item-section>
            </q-item>
            <q-item clickable v-ripple v-scroll-to="'#contacto'" @click="leftDrawerOpen = !leftDrawerOpen">
              <q-item-section>
                Contacto
              </q-item-section>
            </q-item>
